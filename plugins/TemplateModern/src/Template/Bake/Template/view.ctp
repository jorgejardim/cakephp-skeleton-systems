    ...
    <div class="container">
        ...
        <div class="page-actions pull-md-right">
            <div class="btn-group" role="group">
                <a href="<?= $this->Url->build(['action' => 'edit', <%= $pk %>]) ?>" class="btn btn-page-action"><i class="fa fa-edit"></i> <?= __('Edit'); ?></a>
                <?= $this->Form->postLink('<i class="fa fa-trash-o"></i> ' . __('Delete'), ['action' => 'delete', <%= $pk %>], ['confirm' => __('Are you sure you want to delete?', <%= $pk %>), 'escape' => false, 'class' => 'btn btn-page-action btn-page-action-delete']) ?>
