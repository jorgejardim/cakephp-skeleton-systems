...
%>
                ...
                <nav role="navigation" class="navbar navbar-default navbar-page-actions">
                    ...
                    <div id="navbarCollapseActionsPage" class="collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li><?= $this->Form->postLink('<i class="fa fa-trash-o"></i> ' . __('Delete'), ['action' => 'delete', <%= $pk %>, '?' => @$this->request->query], ['confirm' => __('Are you sure you want to delete?', <%= $pk %>), 'escape' => false, 'class' => 'btn-page-action btn-page-action-delete']) ?></li>
        ...
        <div class="breadcrumbs">
            <ul>
                ...
                <li>
                    <?= $this->Html->link(__('<%= Inflector::humanize($action) %>'), ['action' => 'view', <%= $pk %>, '?' => @$this->request->query]); ?>
                </li>
            </ul>
        </div>
