...
class ModulesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'module' => ['type' => 'string', 'length' => 30, 'null' => false, 'default' => null, 'comment' => 'site, juridico, hotel, curso, cursos, projetos', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'modules_domains' => ['type' => 'foreign', 'columns' => ['domain_id'], 'references' => ['domains', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
