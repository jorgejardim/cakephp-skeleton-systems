...
/**
 * ContentsCommentsFixture
 *
 */
class ContentsCommentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'content_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'contents_comments_comments' => ['type' => 'foreign', 'columns' => ['parent_id'], 'references' => ['contents_comments', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
            'contents_comments_contents' => ['type' => 'foreign', 'columns' => ['content_id'], 'references' => ['contents', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
            'contents_comments_users' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'ip' => 'Lorem ipsum d',
            'status' => 1,
            'created' => '2015-07-25 11:21:38',
            'modified' => '2015-07-25 11:21:38'
        ],
    ];
}
