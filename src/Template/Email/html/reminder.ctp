...
<div>
    ...
    <p style="line-height:20px;color:#666">Link: <a target="_blank" style="color:#F60" href="<?php echo $this->Url->build('/login', true); ?>"><?php echo $this->Url->build('/login', true); ?></a></p>
