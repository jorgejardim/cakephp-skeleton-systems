                ...
                <nav role="navigation" class="navbar navbar-default navbar-page-actions">
                    ...
                    <div id="navbarCollapseActionsPage" class="collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li><?= $this->Form->postLink('<i class="fa fa-trash-o"></i> ' . __('Delete'), ['action' => 'delete', $test->id, '?' => @$this->request->query], ['confirm' => __('Are you sure you want to delete?', $test->id), 'escape' => false, 'class' => 'btn-page-action btn-page-action-delete']) ?></li>
        ...
        <div class="breadcrumbs">
            <ul>
                ...
                <li>
                    <?= $this->Html->link(__('View'), ['action' => 'view', $test->id, '?' => @$this->request->query]); ?>
                </li>
            </ul>
        </div>
