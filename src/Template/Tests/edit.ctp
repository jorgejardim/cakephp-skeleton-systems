                ...
                <nav role="navigation" class="navbar navbar-default navbar-page-actions">
                    ...
                    <div id="navbarCollapseActionsPage" class="collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="<?= $this->Url->build(['action' => 'view', $test->id, '?' => @$this->request->query]) ?>" class="btn-page-action"><i class="fa fa-eye"></i> <?= __('View'); ?></a></li>
        ...
        <div class="breadcrumbs">
            <ul>
                ...
                <li>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $test->id, '?' => @$this->request->query]); ?>
                </li>
            </ul>
        </div>
        <div class="row">
