...
class CommonComponent extends Component
{
    ...
    public function clear_cache() {
        Cache::clear(false, 'hour_'.$this->request->session()->read('Domain.id'));
        Cache::clear(false, 'day_'.$this->request->session()->read('Domain.id'));
        Cache::clear(false, 'year_'.$this->request->session()->read('Domain.id'));
    }
}