...
class TestsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->add('date', 'valid', ['rule' => 'date', 'message' => __('The provided value for the {0} field is invalid', __('Date'))])
            ->requirePresence('date', 'create', __('This field {0} is required', __('Date')))
            ->notEmpty('date', __('This field {0} is required', __('Date')));
            
        $validator
            ->add('calendar', 'valid', ['rule' => 'datetime', 'message' => __('The provided value for the {0} field is invalid', __('Calendar'))])
